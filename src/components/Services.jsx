        ...
        <div className="relative">
          ...
          >
            ...
            <Generating
             ...
             border-n-1/10 border w-[22rem] md:w-[25rem]
             lg:left-1/2 lg:right-auto lg:bottom-8
             lg:-translate-x-1/2 m-auto
             "
            />
          </div>
          ...
          >
            ...
            >
              ...
              flex-col justify-end p-8 lg:p-15
              bg-gradient-to-b from-n-8/0 to-n-8/90
              "
              >
                <h4 className="h4 mb-4">Photo editing</h4>
                <p className="body-2 mb-[3rem] text-n-3">
                  Automatically enhance your photos ysing our AI app's photo
                  editing geature. try it now!
                </p>
              </div>
            ...
            >
              <div className="py-12 px-4 xl:px-8">
                <h className="h4 mb-4">Video generation</h>
